...
half = (10 ** 9) // 2
CASES = [[((0, 0), (10 ** 9) - 5), ((5, -5), (10 ** 9) - 5),((-5, -5), (10 ** 9) - 5),((5, 5), (10 ** 9) - 5),((-5, 5), (10 ** 9) - 5)],#((0, 0), (10 ** 9) - 4)
#CASES = [[((0, 0), (10 ** 9) - 5), ((5, -5), (10 ** 9) - 5)],#((0, 0), (10 ** 9) - 4)
         [((0, 0), (10 ** 9) - 50), ((-50, 50), (10 ** 9) - 50)],
         [((0, 50), half),((50, 50), half),((-50, -50), half),((50, -50), half),((-50, 50), half), ((half, half), half),((-half, -half), half),((half, -half), half),((-half, half), half),((0, 0), (10 ** 9))]]
